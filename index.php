...
<body>
  ...
  <footer id="footers">
      ...
      <div class="row">
        <div class="col span-1-of-3">
          <ul class="information">
            <h2>Address</h2>
            <li><i class="fas fa-map-marker-alt"></i>Address: 30, Nguyen Van Linh street, Ninh Kieu District, Can Tho City</li>
            <li><i class="fas fa-envelope"></i>Email: nhuhbngcc19171@fpt.edu.vn</li>
            <li><i class="fas fa-phone"></i>Phone: (+84)88215437</li>
          </ul>
        </div>
        <div class="col span-1-of-3">
          <div class="social-icons">
            <div class="information">
              <h2>About Us</h2>
              <p>Cherry is a stationery store that supports and sells stationery, consumer electronics, and services.
              </p>
            </div>
          </div>
        </div>
    ...
    <p class="copyright">
      Copyright &copy; 2022 by Cherry Team
    </p>
  </footer>
